...
export function RegisterPage() {
    ...
    try {
      ...
      if (role === 'DRIVER' && licenseFile) {
        ...
        if (!uploadErr) {
          ...
          licenseImageUrl = urlData?.publicUrl || null;
        }
      }
  ...
  return (
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#f1f5f9', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      
      <div style={{ width: '100%', maxWidth: currentStep === 'details' ? 760 : 500, backgroundColor: '#ffffff', borderRadius: 20, boxShadow: '0 10px 40px rgba(0,0,0,0.06)', border: '1px solid #e2e8f0', overflow: 'hidden', transition: 'max-width 0.3s ease' }}>
