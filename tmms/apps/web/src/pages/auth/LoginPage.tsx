...
import { AlertCircle, Eye, EyeOff, LogOut, ArrowRight } from 'lucide-react';
          ...
          {user ? (
            ...
            <>
              ...
              <p style={{ marginTop: 20, textAlign: 'center', fontSize: '0.78rem', color: '#94a3b8' }}>
                Driver or Operator?{' '}
                <a href="http://localhost:5174/login" style={{ color: '#1d4ed8', fontWeight: 600, textDecoration: 'none' }}>Use the Driver/Operator Portal →</a>
              </p>
            </>
          )}
        </div>
