...
import { AlertCircle, Eye, EyeOff, LogOut, ArrowRight, ArrowLeft } from 'lucide-react';
          ...
          <div style={{
            ...
            <div style={{ marginBottom: 20 }}>
              <Link to="/" style={{
                ...
                fontSize: '0.75rem', color: '#475569', textDecoration: 'none',
                fontWeight: 600, background: '#f1f5f9', padding: '6px 12px',
