...
import {
  CheckCircle, XCircle, Clock, Search, Eye, X, UserCheck,
  Building2, Phone, Mail, FileImage, AlertTriangle
} from 'lucide-react';
          ...
          <div style={{ padding: '24px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 16 }}>
              <div style={{ background: '#f8fafc', borderRadius: 8, padding: 12, display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.85rem', color: '#0f172a', fontWeight: 500, wordBreak: 'break-all' }}>{user.email}</div>
                </div>
              </div>
              <div style={{ background: '#f8fafc', borderRadius: 8, padding: 12, display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '0.85rem', color: '#0f172a', fontWeight: 500 }}>{contactNumber || '—'}</div>
                </div>
              </div>
            </div>
            ...
            {isDriver && (
              <div style={{ marginBottom: 16 }}>
                <div style={{ fontSize: '0.65rem', fontWeight: 700, color: '#94a3b8', letterSpacing: '0.08em', marginBottom: 8 }}>
                  DRIVER'S LICENSE IMAGE
                </div>
                {licenseUrl ? (
                  <div style={{ border: '1px solid #e2e8f0', borderRadius: 8, overflow: 'hidden', cursor: 'pointer', position: 'relative' }}
                    onClick={() => setShowLicenseModal(true)}
                  >
                    <img
                      src={licenseUrl}
                      alt="Driver's License"
                      style={{ width: '100%', maxHeight: 200, objectFit: 'contain', display: 'block', background: '#f8fafc' }}
                    />
                    <div style={{
                    ...
                    >
                      <Eye size={24} color="white" style={{ opacity: 0, transition: 'opacity 0.2s' }} className="license-zoom-icon" />
                    </div>
                    <div style={{ padding: '6px 10px', background: '#eff6ff', fontSize: '0.72rem', color: '#1d4ed8', display: 'flex', alignItems: 'center', gap: 6 }}>
                      <FileImage size={12} /> Click to view full size
                    </div>
                  </div>
                ) : (
