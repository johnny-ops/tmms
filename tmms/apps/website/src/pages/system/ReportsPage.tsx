          ...
          <div className="card" style={{ padding: 24 }}>
            ...
            {generated && (
              <div style={{ marginTop: 24 }}>
                <div style={{ fontWeight: 600, color: '#1e293b', marginBottom: 10, padding: '6px 0', borderBottom: '2px solid #e2e8f0', display: 'flex', alignItems: 'center', gap: 8 }}>
                  <FileText size={16} color="#3a65ae" /> Report Preview — First 5 Records
                </div>
