...
import { ParkingSquare, Grid, List, Plus, X } from 'lucide-react';
        ...
        {selectedSlot && (
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
              ...
              <button className="btn btn-ghost btn-sm" onClick={() => setSelectedSlot(null)} style={{ padding: 4 }}><X size={16} /></button>
            </div>
