...
export function ForecastingPage() {
  ...
  return (
    <div>
      ...
      <div style={{ padding: 24, borderTop: '1px solid #e2e8f0', background: '#f8fafc', fontSize: '0.8rem', color: '#64748b' }}>
        <div style={{ display: 'flex', gap: 6 }}>
          <AlertTriangle size={16} color="#f59e0b" style={{ flexShrink: 0 }} />
          <span>
            <strong>Model Disclaimer:</strong> Forecasts are generated from available transportation data and are intended for planning and operational purposes. Accuracy metrics (MAE, RMSE) are based on validation splits from historical data. Actual results may vary due to unobserved variables (weather, events, holidays). This system does not claim real-time traffic data unless explicitly connected to a live data source.
          </span>
        </div>
      </div>
    </div>
